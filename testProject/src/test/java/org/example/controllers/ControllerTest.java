...
public class ControllerTest {
    ...
    void whenAStringOfTwoWords () {
        ...
        ResponseEntity<?> expected = new ResponseEntity<>(Math.ceil(300000.0 / 12 / 29.3 * 7 * 100) / 100, HttpStatus.OK);
    ...
    @Test
    void whenAStringOfOneWord(){
        String str = "300000";
        HttpStatusCode actual = controller.calculate(str).getStatusCode();
        HttpStatusCode expected = HttpStatusCode.valueOf(400);
        assertThat(actual).isEqualTo(expected);
    }
}
